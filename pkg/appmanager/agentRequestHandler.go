...
func (appMgr Manager) deployResource() error {
	...
	deployCfg := ResourceRequest{Resources: appMgr.resources,
		...
		IntDgMap: appMgr.intDgMap, IntF5Res: appMgr.intF5Res, AgentCfgmap: appMgr.agentCfgMap}
...
func (appMgr Manager) deployARP(members map[Member]struct{}) error {
	...
	deployCfg := ResourceRequest{Resources: appMgr.resources, PoolMembers: members}
	// Generate Agent Request
