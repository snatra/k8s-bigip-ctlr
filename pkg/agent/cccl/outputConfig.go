...
//func (appMgr *CCCLManager) outputConfig() {
...
//			// TODO SNATRA
//			//appMgr.postAS3Declaration()
//
//			appMgr.steadyState = true
//		}
//		//appMgr.as3ActiveConfig.as3RsrcType = ""
//	default:
...
// lock held.
func (appMgr *CCCLManager) OutputConfigLocked() {
	...
	// TODO SNATRA remove below logic from here, this has to happen in a different function, this function will contain only l4-l7
	...
	// TODO SNATRA these conditions willmove into appManager
	//if appMgr.processedItems >= appMgr.queueLen || appMgr.steadyState {
	...
	// TODO SNATRA this instruction also move into appManager
	//	appMgr.steadyState = true
	//}
}

func (appMgr *CCCLManager) SendFDBEntries() {
...
func (appMgr *CCCLManager) SendARPEntries() {
